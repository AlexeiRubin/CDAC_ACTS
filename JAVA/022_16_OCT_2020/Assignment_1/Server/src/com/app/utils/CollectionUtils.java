...
public class CollectionUtils {
	...
	public static List<Student> populateList() {
		List<Student> students = Arrays.asList(new Student("101A", "A", parse("1990-01-10"), CPP, 7.7),
				...
				new Student("107A", "D", parse("1989-08-05"), JAVA, 6.8),
	...
	public static HashMap<String, Student> sampleDataForMap(List<Student> studentDetails) {
		HashMap<String, Student> studentDetailsMap = new HashMap<>();

		for (Student student : studentDetails)
			studentDetailsMap.put(student.getStudentRollNo(), student);
