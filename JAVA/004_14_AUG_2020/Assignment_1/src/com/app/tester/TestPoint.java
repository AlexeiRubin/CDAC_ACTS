	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 1:
				...
				if ((pointPlotIndex > (pointCoordinates.length - 1)) || (pointPlotIndex < 0))
					...
					if (pointCoordinates[pointPlotIndex].isEmpty()) {
						...
						pointCoordinates[pointPlotIndex] = new Point2D(in.nextDouble(), in.nextDouble());
					} else
			...
			case 3:
				...
				System.out.println(
						"\nDistance between First Point and Second Point is : " + pointCoordinates[firstPointPlotIndex]
								.calculateDistance(pointCoordinates[secondPointPlotIndex]) + " units");
