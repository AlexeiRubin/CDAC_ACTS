...
public class CustomerService {
	...
	public void sortByCustomerEmailIdService() {
		customerDaoImpl.sortByCustomerEmailId();
	}

	public void sortByCustomerDateOfBirthAndCustomerTypeService() {
		customerDaoImpl.sortByCustomerDateOfBirthAndCustomerType();
	}

	public void sortByCustomerDateOfBirthAndCustomerCityService() {
		customerDaoImpl.sortByCustomerDateOfBirthAndCustomerCity();
	}
}