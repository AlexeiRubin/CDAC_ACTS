...
public class BookDaoImpl implements BookDao {
	...
	@Override
	public void addBookToCart(String bookTitle, int quantity) throws BookStoreException {
		...
		if (bookDetails.get(index).getBookQuantity() == 0)
			throw new BookStoreException("~~~~~~~BOOK STOCK NOT AVAILABLE~~~~~~~");
	...
	@Override
	public void removeBookFromCart(String bookTitle) throws BookStoreException {
